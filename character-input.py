...
that you explicitly write out the year (and therefore be out of date the 
next year). If you want to do this in a generic way, see exercise 39.
...
print(int(favorite_number) * ('Hi ' + name + '! You will turn 100 years old in ' + str(answer) + '.\n'))
